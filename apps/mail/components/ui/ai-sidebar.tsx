...
// Upgrade prompt component for non-Pro users
  ...
  return (
    <div className="flex h-full flex-col items-center justify-center gap-4 p-6 text-center">
      ...
      <p className="text-sm text-muted-foreground">
        You've used all your free AI messages. Upgrade to Pro for unlimited AI chat access.
      </p>
      <Button
...
function AISidebar({ className }: AISidebarProps) {
  const { open, setOpen, isFullScreen, setIsFullScreen, toggleViewMode, isSidebar, isPopup } =
    useAISidebar();
  const { isPro, track, refetch: refetchBilling, chatMessages } = useBilling();
