...
const sections = [
  {
    ...
    content: (
      <p>
        Nubo is an open-source email solution that enables users to self-host their email service
        or integrate with external email providers. By using Nubo, you agree to these terms.
      </p>
    ),
  },
  {
      ...
      <div className="space-y-8">
        <div>
          ...
          <ul className="ml-4 list-disc space-y-2">
            <li>Nubo provides software that users can deploy on their own infrastructure</li>
        ...
        <div>
          ...
          <ul className="ml-4 list-disc space-y-2">
            <li>Nubo can integrate with third-party email providers</li>
  ...
  },
  {
    ...
    content: (
      <div className="text-muted-foreground mt-4 space-y-3">
        <p>Nubo is licensed under the MIT License:</p>
        <ul className="ml-4 list-disc space-y-2">
