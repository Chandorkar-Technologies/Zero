...
const sections = [
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          At Nubo, we believe that privacy is a fundamental right. Our open-source email solution is
        ...
        <ul className="ml-4 list-disc space-y-2">
          <li>
            Nubo Email Storage: We never store your emails - they remain in your Gmail account
          </li>
  ...
  },
  {
    ...
    content: (
      <>
        <p className="mb-4">When you use Nubo with your Google Account:</p>
        <ul className="ml-4 list-disc space-y-2">
      ...
      <div className="space-y-6">
        <div>
          ...
          <ul className="ml-4 list-disc space-y-2">
            ...
            <li>This data is used exclusively for providing email functionality within Nubo</li>
    ...
    content: (
      <div className="space-y-6">
        <div>
          ...
          <ul className="ml-4 list-disc space-y-2">
            <li>
              Nubo offers a free plan with basic features that requires no payment information
            </li>
        ...
        <div>
          ...
          <ul className="ml-4 list-disc space-y-2">
            ...
            <li>Subscription charges will appear on your billing statement as "Nubo Email"</li>
            <li>
